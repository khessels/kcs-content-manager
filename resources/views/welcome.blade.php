...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Kcs Content Manager</title>
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <img src="/img.png" style="height:80px;" alt="..."/>
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">KCS Content Manager</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        A headless CMS for programmers and by programmers. All the professional features without the price
                                    </p>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">By Developers For Developers</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        We want i18n but without the hassle. Generate and translate your content quick and with ease!
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Designed for Laravel</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        The best way to lower your TCO and successfully deploy and maintain your content.
                                    </p>
                                </div>
                            </div>
                        </div>
